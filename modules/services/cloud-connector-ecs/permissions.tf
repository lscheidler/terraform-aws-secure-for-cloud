locals {
  ecs_task_role_id          = var.is_organizational && var.organizational_config.connector_ecs_task_role_name != null ? data.aws_iam_role.task_inherited[0].id : aws_iam_role.task[0].id
  ecs_task_role_arn         = var.is_organizational && var.organizational_config.connector_ecs_task_role_name != null ? data.aws_iam_role.task_inherited[0].arn : aws_iam_role.task[0].arn
  ecs_task_role_name_suffix = var.is_organizational && var.organizational_config.connector_ecs_task_role_name != null ? var.organizational_config.connector_ecs_task_role_name : var.connector_ecs_task_role_name
}
...
data "aws_iam_role" "task_inherited" {
  count = var.is_organizational && var.organizational_config.connector_ecs_task_role_name != null ? 1 : 0
  name  = var.organizational_config.connector_ecs_task_role_name
}

resource "aws_iam_role" "task" {
  count              = var.is_organizational && var.organizational_config.connector_ecs_task_role_name != null ? 0 : 1
